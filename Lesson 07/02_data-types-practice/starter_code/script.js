...
if(typeof iDoNotExist == "undefined"){ console.log("iDoNotExist has not been set")}

function addMe(cucumber, tomato){console.log(cucumber + tomato)};

function hal(myName){console.log("I'm sorry," + myName + ". I'm afraid I can't do that.")}
